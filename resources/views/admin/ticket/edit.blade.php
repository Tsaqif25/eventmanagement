                ...
                <form action="{{ route('admin.ticket.update', $ticket->id) }}" method="POST">
                    ...
                    <div class="flex flex-col gap-y-5">
                        ...
                        <div>
                            ...
                            <input type="number" name="availability" id="availability" class="border border-gray-300 rounded-lg px-4 py-2 w-full" value="{{ old('availability', $ticket->availability) }}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="price" id="price" class="border border-gray-300 rounded-lg px-4 py-2 w-full" step="0.01" value="{{ old('price', $ticket->price) }}" required>
                        </div>
