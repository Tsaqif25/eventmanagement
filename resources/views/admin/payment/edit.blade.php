            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        @if($about->thumbnail)
                            <img src="" alt="Thumbnail" class="rounded-2xl object-cover w-[90px] h-[90px] mb-2">
                        @endif
                    ...
                    <div class="mt-4">
                        <div class="flex flex-col gap-y-5">
                            ...
                            {{-- @php
                                // Jika keypoints tidak ada atau null, gunakan array kosong
                                $keypoints = old('keypoints', $about->keypoints ?? []);
                            @endphp
                            @for($i = 0; $i < 3; $i++) --}}
